...
namespace config {
    ...
    constexpr auto one_day_in_seconds = 24 * one_hour_in_seconds; // 3 minutes for debug purposes
    constexpr auto one_week_in_seconds = one_day_in_seconds * 7;
    constexpr auto one_month_in_seconds = 30 * one_day_in_seconds;  // 5 minutes for debug purposes
    constexpr auto distribution_expire_in_seconds = 60;  // 1 minute for debug purposes
    ...
    tables::DiceLimit init_dice_limits()
    {
        return {
                0,      /*min_value*/
                100,    /*max_value*/
                1.00,   /*max_bet_percent*/
                100,    /*max_bet_num*/
                eosio::asset(1, common::EOS_SYMBOL),     /*min_bet*/
                eosio::asset(0, common::EOS_SYMBOL),     /*balance_protect*/
                0.0,    /*platform_fee*/
        };
    }
    ...
    constexpr tables::AnteBonus ante_bonuses[] = {
            {1, 10, 1.01},
            {11, 20, 1.02},
            {21, 30, 1.03},
            {31, 40, 1.04},
